...
def lanResponseHandler(evt) {
    ...
    // Test getting IP to Hex for networkid
...
private addTemperatureSensorDeviceType() {
    ...
    if (!getChildDevice(deviceId)) {
        def d = addChildDevice("TemperatureSensor", "Temperature Sensor", deviceId, ["name": deviceName, label: deviceName, completedSetup: true])
